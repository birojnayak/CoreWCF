...
namespace NetCoreServer
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            CoreWCF.NetTcpBinding netTcpBinding = new CoreWCF.NetTcpBinding(SecurityMode.TransportWithMessageCredential);
            ...
            app.UseServiceModel(builder =>
            {
                ...
                builder.AddServiceEndpoint<EchoService, Contract.IEchoService>(netTcpBinding, "/nettcp");
